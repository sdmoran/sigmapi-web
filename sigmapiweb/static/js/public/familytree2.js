function generateFamilyTree(containerID, treeData)
{
    ...
    // size of the diagram
    let viewerWidth = $(`#${containerID}`).width();
    let viewerHeight = $(`#${containerID}`).height();
    ...
    let baseSvg = d3.select(`#${containerID}`).append("svg")
    ...
    function update(source) {
        ...
        childCount(0, root);
        let newHeight = d3.max(levelWidth) * 75; // 25 pixels per line
