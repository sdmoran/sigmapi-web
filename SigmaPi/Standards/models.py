...
class SummonsRequest(models.Model):
	...
	summoner = models.ForeignKey(User, related_name="requester")
	summonee = models.ForeignKey(User, related_name="target")
	reason = models.TextField()
...
class SummonsRequestForm(ModelForm):
	"""
...
class Summons(models.Model):
	...
	"""
	summoner = models.ForeignKey(User, related_name="summoner")
	summonee = models.ForeignKey(User, related_name="summonee")
...
class SummonsHistoryRecord(models.Model):
	...
	hasBone = models.BooleanField()
	boneID = models.PositiveIntegerField()


class AddSummonsForm(ModelForm):
	"""
...
class AcceptSummonsForm(ModelForm):
	"""
